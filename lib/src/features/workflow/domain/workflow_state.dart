...
final class RobotRosettenState extends WorkflowState {
  @override
  bool isReady(Matrix matrix) =>
      !matrix.rosetteA && !matrix.rosetteB && matrix.gewinde && matrix.box;
}
...
final class BoxState extends WorkflowState {
  @override
  bool isReady(Matrix matrix) => !matrix.rosetteA && !matrix.rosetteB && !matrix.gewindeA && !matrix.gewindeB && !matrix.box;
}
